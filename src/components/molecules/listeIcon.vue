...
<template>
  <div class="card">
    <a class="social-link1" href="https://github.com/THONY-HR">
    ...
    <a class="social-link2" href="https://www.linkedin.com/in/anthony-herinantenaina/">
    ...
    <a class="social-link4" href="https://www.facebook.com/thony.hr.52">
